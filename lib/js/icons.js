...
var space_image = new google.maps.MarkerImage("/images/map/space.png",
  new google.maps.Size(39, 47),
  new google.maps.Point(0, 0),
  new google.maps.Point(0, 47));
var space_visited = new google.maps.MarkerImage("/images/map/space.visited.png",
  new google.maps.Size(39, 47),
  new google.maps.Point(0, 0),
  new google.maps.Point(0, 47));
var space_shadow = new google.maps.MarkerImage("/images/map/space.shadow.png",
...
var gardener_image = new google.maps.MarkerImage("/images/map/gardener.png",
  new google.maps.Size(46, 46),
  new google.maps.Point(0, 0),
  new google.maps.Point(0, 46));
var gardener_visited = new google.maps.MarkerImage("/images/map/gardener.visited.png",
  new google.maps.Size(46, 46),
  new google.maps.Point(0, 0),
  new google.maps.Point(0, 46));
var gardener_shadow = new google.maps.MarkerImage("/images/map/gardener.shadow.png",
...
var typeIcon = function(type) {
  ...
  switch (type) {
    case 'farmer':
      this.main = gardener_image;
      this.visited = gardener_visited;
      this.shadow = gardener_shadow;
      this.shape = gardener_shape
      break;
    case 'gardener':
      this.main = gardener_image;
      this.visited = gardener_visited;
      ...
      break;
    case 'space':
      this.main = space_image;
      this.visited = space_visited;
      this.shadow = space_shadow;
      this.shape = space_shape
      break;
    case 'garden':
      this.main = space_image;
      this.visited = space_visited;
